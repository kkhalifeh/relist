...
ann = User.create(name: "Ann", username: "ann", email: "ann@ironflat.com", age: 23)
biz = User.create(name: "Biz", username: "biz", email: "biz@ironflat.com", age: 24)
dan = User.create(name: "Dan", username: "dan", email: "dan@ironflat.com", age: 25)
ian = User.create(name: "Ian", username: "ian", email: "ian@ironflat.com", age: 26)
jon = User.create(name: "Jon", username: "jon", email: "jon@ironflat.com", age: 27)
kip = User.create(name: "Kip", username: "kip", email: "kip@ironflat.com", age: 28)
len = User.create(name: "Len", username: "len", email: "len@ironflat.com", age: 29)
